...
public class course2 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (str.equals("ADD COURSE")) {
            new addcourse();
            this.setVisible(false);
        } else if (str.equals("BACK")) {
            new home2();
            this.setVisible(false);
        } else if (str.equals("EDIT COURSE")) {
            new editcourse();
            this.setVisible(false);

        } else if (str.equals("REMOVE COURSE")) {
            new removecourse();
            this.setVisible(false);
        } else if (str.equals("VIEW COURSE")) {
            new viewcourse();
            this.setVisible(false);
        }
