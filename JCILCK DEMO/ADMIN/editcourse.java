...
//client programm
public class editcourse extends JFrame implements ActionListener, FocusListener {
    ...
    public editcourse() {
        ...
        setTitle("UPDATING THE COURSE DETAILS");
    ...
    public void focusGained(FocusEvent fe) {
        ...
        try {
            String qr2 = "select * from course where CourseId='" + str + "'";
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (str.equals("CLEAR")) {
            ...
            try {
                String sql = "update course set CourseName='" + t1.getText() + "', Duration='" + t3.getText()
                        + "',Description='" + t4.getText() + "',fee='" + t5.getText() + "' WHERE CourseId  ='"
                        + jc.getSelectedItem() + "'";
