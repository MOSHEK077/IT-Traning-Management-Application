...
public class deletebat extends JFrame implements ActionListener, FocusListener {
    Connection cn;
    Statement st;
    JComboBox jc;
    ResultSet rs;
    ...
    public deletebat() {
        ...
        h1 = new JLabel("REMOVE BATCH");
        h1.setFont(f);
        // l1.setBackground(clr);
        h1.setBounds(820, 50, 800, 50);
        c.add(h1);
        ...
        setTitle("DELETE THE BATCH DETAILS");
    ...
    public void focusGained(FocusEvent fe) {
        try {
            ...
            String qr = "select * from batch where batchid  ='" + str + "'";
            rs = st.executeQuery(qr);
            if (rs.next()) {
                t1.setText("Batch Name:" + rs.getString(2) + "\nCourse: " + rs.getString(3));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (str.equals("BACK")) {
            ...
            try {
                ...
                System.out.println(in.delete(st));
            } catch (Exception e) {
                e.printStackTrace();
            }
